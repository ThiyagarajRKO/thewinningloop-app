...
function Svg({ size = 16, children }) {
  return (
    <svg className="ico" width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" {...P}>
      {children}
    </svg>
  );
}
...
export const Icon = {
  ...
  store: p => <Svg {...p}><path d="m2 7 1-4h18l1 4" /><path d="M2 7h20v3a3 3 0 0 1-6 0 3 3 0 0 1-6 0 3 3 0 0 1-6 0V7z" /><path d="M4 12v9h16v-9" /></Svg>,
  sparkles: p => <Svg {...p}><path d="M12 3v4M12 17v4M3 12h4M17 12h4" /><path d="m6.3 6.3 2.4 2.4M15.3 15.3l2.4 2.4M17.7 6.3l-2.4 2.4M8.7 15.3l-2.4 2.4" /></Svg>,
  download: p => <Svg {...p}><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><path d="m7 10 5 5 5-5M12 15V3" /></Svg>,
  image: p => <Svg {...p}><rect x="3" y="3" width="18" height="18" rx="2" /><circle cx="9" cy="9" r="2" /><path d="m21 15-4.35-4.35a2 2 0 0 0-2.83 0L3 21" /></Svg>,
  message: p => <Svg {...p}><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></Svg>,
  trending: p => <Svg {...p}><path d="m22 7-8.5 8.5-5-5L2 17" /><path d="M16 7h6v6" /></Svg>,
  search: p => <Svg {...p}><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></Svg>,
  chart: p => <Svg {...p}><path d="M3 3v18h18" /><rect x="7" y="12" width="3" height="6" rx="1" /><rect x="12" y="8" width="3" height="10" rx="1" /><rect x="17" y="4" width="3" height="14" rx="1" /></Svg>,
  bookmark: p => <Svg {...p}><path d="m19 21-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" /></Svg>,
  filter: p => <Svg {...p}><path d="M22 3H2l8 9.46V19l4 2v-8.54z" /></Svg>,
  globe: p => <Svg {...p}><circle cx="12" cy="12" r="9" /><path d="M3 12h18M12 3a15 15 0 0 1 0 18 15 15 0 0 1 0-18z" /></Svg>,
  package: p => <Svg {...p}><path d="m12 2 9 5v10l-9 5-9-5V7z" /><path d="m3 7 9 5 9-5M12 12v10" /></Svg>,
...
export function BrandMark({ size = 22 }) {
  return (
    <svg className="brand-mark" width={size} height={size} viewBox="0 0 24 24" aria-hidden="true">
      <path d="M12 1.6 21.2 7v10L12 22.4 2.8 17V7z" fill="none" stroke="var(--primary)" strokeWidth="1.6" strokeLinejoin="round" />
      <rect x="8" y="12.5" width="2.6" height="5.5" rx="1" fill="var(--primary)" />
      <rect x="13.4" y="6" width="2.6" height="12" rx="1" fill="var(--accent)" />
    </svg>
  );
}
